 ...
 * CRUD operations on subjects with search, table, and delete confirmation
 */
        ...
        <table className="w-full">
          ...
          <tbody className="divide-y divide-border">
            {filteredSubjects.map((subject) => (
              <tr key={subject.id} className="hover:bg-muted/50 h-12">
                <td className="px-4 py-2 text-body">{subject.name}</td>
